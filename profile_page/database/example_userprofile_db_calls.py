...
if __name__ == '__main__':
    ...
    list_game_ids(user["user_id"], board2["cards"])
    print(save_game(user["user_id"],board3))
    delete_game(user["user_id"], board2["game_id"])
