...
class DBCreateUserProfile(TestCase):
    def setUp(self):
        ...
        "current_story_level":9,"email":"ryan@umbc.edu","friends":["Kulsoom2","Nick2","Maksim2","Naomi2"],
        "user_name":"ryan2","password_hash":"well,hello there","points":98274,"rank":"diamond",
        "save_games":["4(2(3)(no))(6(5))","4(2(3)(1))(6(5))","4(2(3)(1))(6(5))"]}
    ...
    def test_save(self):
        ...
        self.assertEqual( created_user, True, msg=f'{BColors.FAIL}\t[-]\tUser was not created in the Database!{BColors.ENDC}' + where() )
    ...
    def test_duplicate_save(self):
        ...
        created_user = mongo.save_user( self.user )
        created_user = mongo.save_user( self.user )
        self.assertEqual( created_user, False, msg=f'{BColors.FAIL}\t[-]\tGame was not created in the Database!{BColors.ENDC}' + where() )
        print(f"{BColors.OKGREEN}\t[+]\tPass User-Profile database save user duplicate.{BColors.ENDC}")
    ...
    def test_create_duplicate_uid(self):
        ...
        self.assertEqual( created_user, False, msg=f'{BColors.FAIL}\t[-]\tDuplicate user was created in the Database!{BColors.ENDC}' + where() )
        print(f"{BColors.OKGREEN}\t[+]\tPass User-Profile database create user duplicate id.{BColors.ENDC}")
...
class DBReadUserProfile(TestCase):
    ...
    def test_read_correct(self):
        ...
        self.assertEqual( read_user["user_id"], self.user["user_id"], msg=f'{BColors.FAIL}\t[-]\tGame Id returned from read board does not equal expected!{BColors.ENDC}' + where() )
    ...
    def test_read_nonexist(self):
        ...
        self.assertEqual( read_user, False, msg=f'{BColors.FAIL}\t[-]\tIncorrect return for non-existant user!{BColors.ENDC}' + where() )
    ...
    def test_read_user_name_nonexist(self):
        ...
        self.assertEqual( read_user, False, msg=f'{BColors.FAIL}\t[-]\tIncorrect return for non-existant user id!{BColors.ENDC}' + where() )
...
class DBUpdateUserProfile(TestCase):
    ...
    def test_update_correct(self):
        ...
        self.assertEqual( updated_user["user_id"], self.user2["user_id"], msg=f'{BColors.FAIL}\t[-]\tUser Id returned from read user does not equal expected!{BColors.ENDC}' + where() )
    ...
    def test_update_nonexist(self):
        ...
        self.assertEqual( updated_user, False, msg=f'{BColors.FAIL}\t[-]\tIncorrect return for non-existant user!{BColors.ENDC}' + where() )
...
class DBUpdateUserGame(TestCase):
    ...
    def test_update_game_correct(self):
        ...
        self.assertEqual( updated_game != original_user, True, msg=f'{BColors.FAIL}\t[-]\tUser Id returned from read user does not equal expected!{BColors.ENDC}' + where() )
        print(f"{BColors.OKGREEN}\t[+]\tPass User-Profile database update.{BColors.ENDC}")
...
class DBDeleteUser(TestCase):
    ...
    def test_delete_correct(self):
        ...
        self.assertEqual( deleted_user, 1, msg=f'{BColors.FAIL}\t[-]\tDatabase was not able to delete the user!{BColors.ENDC}' + where() )
    ...
    def test_delete_nonexist(self):
        ...
        self.assertEqual( deleted_user, self.fail_phrase, msg=f'{BColors.FAIL}\t[-]\tIncorrect return for non-existant user!{BColors.ENDC}' + where() )
...
class DBDeleteGames(TestCase):
    ...
    def test_delete_nonexist(self):
        ...
        self.assertEqual( deleted_user, False, msg=f'{BColors.FAIL}\t[-]\tIncorrect return for non-existant user!{BColors.ENDC}' + where() )
        print(f"{BColors.OKGREEN}\t[+]\tPass User-Profile database delete nonexistant.{BColors.ENDC}")
...
class DBList(TestCase):
    ...
    def test_list_users_correct(self):
        ...
        self.assertEqual( found, True, msg=f'{BColors.FAIL}\t[-]\tAdded user was not in the listed games!{BColors.ENDC}' + where() )
    ...
    def test_list_user_games_correct(self):
        ...
        self.assertEqual(user_games[0], self.user["save_games"][0], msg=f'{BColors.FAIL}\t[-]\tAdded user was not in the listed games!{BColors.ENDC}' + where() )
        print(f"{BColors.OKGREEN}\t[+]\tPass User-Profile database list.{BColors.ENDC}")
...
class DBSaveUserGames( TestCase ):
    ...
    def test_save_game_correct(self):
        ...
        self.assertEqual( saved_game, True, msg=f'{BColors.FAIL}\t[-]\tUser\'s new game was not saved!{BColors.ENDC}' + where() )
    ...
    def test_save_game_duplicate(self):
        ...
        self.assertEqual( saved_game, False, msg=f'{BColors.FAIL}\t[-]\tUser\'s duplicate game was saved!{BColors.ENDC}' + where() )
        print(f"{BColors.OKGREEN}\t[+]\tPass User-Profile database save duplicate game.{BColors.ENDC}")
...
class DBReadUserGames( TestCase ):
    ...
    def test_load_board( self ):
        ...
        self.assertEqual( user_game, self.user["save_games"][0], msg=f'{BColors.FAIL}\t[-]\tUser game save was not found!{BColors.ENDC}' + where() )
    ...
    def test_share_user_game( self ):
        ...
        self.assertEqual( user_share_game, self.user["save_games"][0], msg=f'{BColors.FAIL}\t[-]\tUser game save was not found!{BColors.ENDC}' + where() )
...
class DBUserAuthentication( TestCase ):
    ...
    def test_check_uid_email( self ):
        ...
        self.assertEqual( user_exists, True, msg=f'{BColors.FAIL}\t[-]\tUser doesn\'t exist!{BColors.ENDC}' + where() )
    ...
    def test_check_uid( self ):
        ...
        self.assertEqual( user_exists, True, msg=f'{BColors.FAIL}\t[-]\tUser id doesn\'t exist!{BColors.ENDC}' + where() )
    ...
    def test_check_email( self ):
        ...
        self.assertEqual( user_exists, True, msg=f'{BColors.FAIL}\t[-]\tUser email doesn\'t exist!{BColors.ENDC}' + where() )
    ...
    def test_check_uid_email_incorrect( self ):
        ...
        self.assertEqual( user_exists, False, msg=f'{BColors.FAIL}\t[-]\tUser doesn\'t exist!{BColors.ENDC}' + where() )
    ...
    def test_login_correct( self ):
        ...
        self.assertEqual( logged_in, True, msg=f'{BColors.FAIL}\t[-]\tUser password doesn\'t match!{BColors.ENDC}' + where() )
    ...
    def test_login_incorrect( self ):
        ...
        self.assertEqual( logged_in, False, msg=f'{BColors.FAIL}\t[-]\tUser\'s fake password was accepted!{BColors.ENDC}' + where() )
    ...
    def test_login_incorrect( self ):
        ...
        self.assertEqual( logged_in, False, msg=f'{BColors.FAIL}\t[-]\tFake user\'s fake password was accepted!{BColors.ENDC}' + where() )
    ...
    def test_update_token( self ):
        ...
        self.assertEqual( new_token, True, msg=f'{BColors.FAIL}\t[-]\tUser\'s new token was not saved!{BColors.ENDC}' + where() )
    ...
    def test_update_token_incorrect( self ):
        ...
        self.assertEqual( new_token, False, msg=f'{BColors.FAIL}\t[-]\tFake user\'s new token was saved!{BColors.ENDC}' + where() )
    ...
    def test_check_user( self ):
        ...
        self.assertEqual( is_valid_tok, True, msg=f'{BColors.FAIL}\t[-]\tUser\'s token is not valid!{BColors.ENDC}' + where() )
    ...
    def test_check_user_incorrect( self ):
        ...
        self.assertEqual( is_valid_tok, False, msg=f'{BColors.FAIL}\t[-]\tUser\'s invalid token was valid!{BColors.ENDC}' + where() )
...
class DBUserProfileGeneral( TestCase ):
    ...
    def test_change_password( self ):
        ...
        self.assertEqual( new_passhash, True, msg=f'{BColors.FAIL}\t[-]\tUser\'s cannot reset passhash!{BColors.ENDC}' + where() )
    ...
    def test_change_sharing( self ):
        ...
        self.assertEqual( sharable, True, msg=f'{BColors.FAIL}\t[-]\tUser\'s cannot change sharing!{BColors.ENDC}' + where() )
    ...
    def test_check_share( self ):
        ...
        self.assertEqual( can_share, True, msg=f'{BColors.FAIL}\t[-]\tUser\'s cannot share when they should be able to!{BColors.ENDC}' + where() )
    ...
    def test_share_board(self ):
        ...
        self.assertEqual( game_shared, True, msg=f'{BColors.FAIL}\t[-]\tUser\'s game was not shared!{BColors.ENDC}'  + where())
        print( f"{BColors.OKGREEN}\t[+]\tPass User-Profile database share game.{BColors.ENDC}" )
    ...
    def test_share_board_invalid_source( self ):
        ...
        self.assertEqual( game_shared, False, msg=f'{BColors.FAIL}\t[-]\tFake User\'s game was shared!{BColors.ENDC}' + where() )
    ...
    def test_share_board_invalid_dest( self ):
        ...
        self.assertEqual( game_shared, False, msg=f'{BColors.FAIL}\t[-]\tUser\'s game was shared to fake user!{BColors.ENDC}' + where() )
    ...
    def test_share_board_invalid_gameid( self ):
        ...
        self.assertEqual( game_shared, False, msg=f'{BColors.FAIL}\t[-]\tUser\'s fake game was shared!{BColors.ENDC}' + where() )
