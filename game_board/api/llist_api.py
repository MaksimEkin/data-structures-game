...
def api_overview(request):
    ...
    """
    api_urls = {
        #This might also need to be tweaked since the llist is a solo game   
        'Start Game': '/start_game/<str:difficulty>/<str:player_ids>/<str:data_structures>',
        # This url might need to be changed to the new gameboard that we are making
...
def start_game(request, difficulty, player_ids, data_structures):
    ...
    ## Probably can get rid of player_ids_temp
