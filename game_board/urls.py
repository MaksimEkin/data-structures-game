...
urlpatterns = [
    ...
    path('api/rebalance/<str:graph>/<str:game_id>', views.rebalance, name='game-board-rebalance'),
    path('api/action/<str:card>/<str:game_id>', views.action, name='game-board-action')
]