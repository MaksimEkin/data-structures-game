...
urlpatterns = [
    ...
    path('api/start_game/<str:difficulty>/<str:player_ids>/<str:data_structures>/<str:online>', api.start_game, name='game-board-start_game'),
    path('api/board/<str:game_id>', api.board, name='game-board-game_status'),
    path('api/rebalance/<str:graph>/<str:game_id>', api.rebalance, name='game-board-rebalance'),
